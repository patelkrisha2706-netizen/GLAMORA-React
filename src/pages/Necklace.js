...
const Necklace = () => {
  ...
  const categoryId = 1; // Necklaces category

  // Fetch all products once and shuffle randomly
  ...
  // Load initial batch when products are ready
  useEffect(() => {
  ...
  return (
    <div>
      ...
      <div className="carousel slide" data-bs-ride="carousel">
        <div className="carousel-inner">
          <div className="carousel-item active">
            <img
              src="/image/necklescoverpage.png"
      ...
      <div className="container mt-5">
        <h2 className="text-center mb-4">Necklaces Collection</h2>
                ...
                <div className="card-body text-center px-2">
                  ...
                  <p className="text-muted small mb-1">
                    {p.description?.length > 60
                      ...
                      : p.description || "Beautifully crafted necklace"}
                  </p>
                  <div>
